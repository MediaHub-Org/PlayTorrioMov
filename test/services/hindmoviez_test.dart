...
import 'package:playtorriomov/services/scraper/sites/hindmoviez.dart';
...
void main() {
  ...
  group('HindMoviezScraper Unit & Logic Tests', () {
    test('HindMoviezScraper metadata', () {
    ...
    test('Challenge solver parses and solves Wallarm splash challenge from HTML dump', () {
      // Guarded on a local dump file that only exists on the upstream
      // author's machine -- kept as upstream wrote it (a no-op here) rather
      // than dropped, since it's still useful if that dump is ever added to
