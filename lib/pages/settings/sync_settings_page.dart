...
/// Trakt.tv and Simkl in one place -- both do the same job (cross-device
/// watchlist/history/continue-watching sync), so they used to be two nearly
/// identical pages (status card, connect/disconnect, a description
/// paragraph, and a separate "Cloud Sync Controls" section with its own
/// ListTile that looked like navigation but actually just re-ran the sync).
/// Trimmed down to what the connection actually needs: connect, and once
/// connected, one sync action -- no descriptions, no extra buttons.
