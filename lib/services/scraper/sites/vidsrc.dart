...
class VidSrcScraper extends StreamScraper {
  ...
  Future<List<StreamSource>> scrape({
    ...
    debugPrint('[VidSrcScraper] Resolved tmdbId: $tmdbId for "$title" (year: $year, imdbId: $imdbId)');
    ...
    try {
      ...
      debugPrint('VidSrcScraper error: $e');
    }

    debugPrint('[VidSrcScraper] Found ${sources.length} active stream(s)');
    return sources;
  }
}
