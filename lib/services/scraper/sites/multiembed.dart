...
class MultiEmbedScraper extends StreamScraper {
  ...
  Future<List<StreamSource>> scrape({
    ...
    debugPrint('[MultiEmbedScraper] Resolved tmdbId: $tmdbId for "$title" (year: $year, imdbId: $imdbId)');
    ...
    try {
      ...
      debugPrint('MultiEmbedScraper error: $e');
    }

    debugPrint('[MultiEmbedScraper] Found ${sources.length} active stream(s)');
    return sources;
  }
}
